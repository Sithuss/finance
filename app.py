...
def buy():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO activity (a_id, symbol, shares, price) VALUES (?, ?, ?, ?)", session["user_id"], stock_symbol, shares, stock_price)
...
def sell():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO activity (a_id, symbol, shares, price) VALUES (?, ?, ?, ?)", session["user_id"], symbol, -ggshares, price )
